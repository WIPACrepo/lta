...
export GRIDFTP_DEST_URLS=${GRIDFTP_DEST_URLS:="gsiftp://dtn01.nersc.gov:2811/global/cfs/cdirs/icecubed;gsiftp://dtn02.nersc.gov:2811/global/cfs/cdirs/icecubed;gsiftp://dtn03.nersc.gov:2811/global/cfs/cdirs/icecubed;gsiftp://dtn04.nersc.gov:2811/global/cfs/cdirs/icecubed/lta-bundles"}
