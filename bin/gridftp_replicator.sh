...
export GRIDFTP_DEST_URL=${GRIDFTP_DEST_URL:="gsiftp://dtn05.nersc.gov:2811/global/cscratch1/sd/icecubed/jade-disk"}
export GRIDFTP_TIMEOUT=${GRIDFTP_TIMEOUT:="1200"}
