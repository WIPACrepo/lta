...
export UNPACKER_OUTBOX_PATH=${UNPACKER_OUTBOX_PATH:="/data/user/lta/unpacker_out"}
export UNPACKER_WORKBOX_PATH=${UNPACKER_WORKBOX_PATH:="/data/user/lta/unpacker_work"}
